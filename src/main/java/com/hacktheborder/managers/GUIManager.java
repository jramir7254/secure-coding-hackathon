...
public class GUIManager {
    ...
    public static final int BUTTON_WIDTH = (int)(PANEL_WIDTH / 1.5);
    ...
    public static JXTextField getForms(String placeHolderText) {
        return new JXTextField() {
            {
                putClientProperty("JComponent.roundRect", 50);
                setFont(new Font("Calibri", Font.BOLD, 15));
                setPrompt(placeHolderText);
                setPromptFontStyle(getPromptFontStyle());
